...
{#if recipe}
    <div class="min-h-screen bg-stone-50 flex flex-col md:flex-row">
        ...
        <div class="md:w-3/5 p-8 md:p-8 overflow-y-auto bg-stone-50">
            ...
            <div class="mt-auto"> 
                <a href={`${base}/recipe/${recipe.id}/cook`} class="block w-full bg-[#36644a] text-white text-center py-5 rounded-full text-2xl font-bold shadow-lg transform active:scale-95 transition">
                    Cuisiner
                </a>
            </div>
        </div>
